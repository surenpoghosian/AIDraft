...
//  AI Draft
//
//  Created by Suren Poghosyan on 10.07.23.
//
...
class StoreVM: ObservableObject {
    ...
    private let productIds: [String] = ["com.xetpyrc.ai_draft.pro_monthly"]
    ...
    func cancelSubscription(_ product: Product) {
        
           // Retrieve the subscription product identifier
           let subscriptionProductIdentifier = product.id
           
           // Simulate cancellation by filtering and removing the purchased subscription
           purchasedSubscriptions = purchasedSubscriptions.filter { $0.id != subscriptionProductIdentifier }
       }
